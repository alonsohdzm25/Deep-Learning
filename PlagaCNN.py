...
## URL ='https://tfhub.dev/google/tf2-preview/mobilenet_v2/classification/3'
...
model.add(tf.keras.layers.Conv2D(128,(3,3), activation='relu', padding='same', input_shape=(img_size,img_size,3)))
